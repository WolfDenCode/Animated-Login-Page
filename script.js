...
signUpButton.addEventListener("click", function () {
    if (signUpHolder.classList.contains("unswitched") || !signUpHolder.classList.contains("switched")) {
        ...
        holderH3.innerHTML = "Sign-in To Continue Your Important Activities On Our Website!"
        ...
        holderH3.innerHTML = "If you are new here and don't know where to start, just sign up to visit our page!"
